...
<body>
	...
	<div class="container mt-5 pb-3">
		<h2 class="card-header text-center">Delivered Orders <i class='fas fa-dolly'></i></h2>
		<table class="table table-light mt-2" style="margin-bottom: 30px;">
			...
			try{
				...
				ResultSet rs = st.executeQuery("select * from user_database.orders where order_status='Delivered'");
				while(rs.next())
				{
			%>
