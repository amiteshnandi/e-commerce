...
<body>
	...
	if ("done".equals(msg)) {
	%>
	<h3 class="alert text-center" style="color:#2ecc71;">Product Successfully Updated!</h3>
	<%
	}
	%>
	<%
	if ("wrong".equals(msg)) {
	%>
	<h3 class="alert text-center" style="color:#e74c3c;">Something went wrong! Try again!</h3>
	<%
	}
	%>

	<div class="container mt-5 pb-3">
		<h2 class="card-header text-center">All Products & Edit Products <i class='fab fa-elementor'></i></h2>
		<table class="table table-light mt-2" style="margin-bottom: 30px;">
			...
			try{
				...
				ResultSet rs = st.executeQuery("select * from user_database.products");
				while(rs.next())
				{
			%>
				...
				<tr>
					...
					<td><a id="table-link" href="editProduct.jsp?id=<%=rs.getString(1) %>">Edit <i class='fas fa-pen-fancy'></i></a></td>
				</tr>
				<%
				}
			}
